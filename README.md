...
**Quick generation (the ordinary default):** the AI goes straight to authoring and export unless you explicitly request a separate strategy/confirmation, interactive preview/annotation, Design Spec/lock governance, or reusable native Master/Layout structure.
