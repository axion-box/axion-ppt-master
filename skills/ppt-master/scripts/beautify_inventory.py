...
Examples:
    python3 scripts/beautify_inventory.py ~/ppt/YYYY-mm/x_ppt169_YYYYMMDD/analysis/<stem>.slide_library.json \
        --images ~/ppt/YYYY-mm/x_ppt169_YYYYMMDD/images/image_manifest.json -o ~/ppt/YYYY-mm/x_ppt169_YYYYMMDD/analysis/beautify_inventory.json
