...
Examples:
    python3 scripts/beautify_identity.py ~/ppt/YYYY-mm/x_ppt169_YYYYMMDD/sources/deck.pptx
    python3 scripts/beautify_identity.py deck.pptx -o ~/ppt/YYYY-mm/x_ppt169_YYYYMMDD/analysis/deck.identity.json
