...
Examples:
    python3 scripts/total_md_split.py ~/ppt/YYYY-mm/<svg_title>_ppt169_YYYYMMDD
    python3 scripts/total_md_split.py ~/ppt/YYYY-mm/<svg_title>_ppt169_YYYYMMDD -o notes
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
    %(prog)s ~/ppt/YYYY-mm/<svg_title>_ppt169_YYYYMMDD
    %(prog)s ~/ppt/YYYY-mm/<svg_title>_ppt169_YYYYMMDD -o notes
    %(prog)s ~/ppt/YYYY-mm/<svg_title>_ppt169_YYYYMMDD -q
