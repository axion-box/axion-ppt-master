...
Examples:
    python3 scripts/icon_sync.py ~/ppt/YYYY-mm/deck_ppt169_YYYYMMDD chunk-filled/home tabler-outline/chart
    python3 scripts/icon_sync.py ~/ppt/YYYY-mm/deck_ppt169_YYYYMMDD simple-icons/github
